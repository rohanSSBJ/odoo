...
/* ---------------------------------------------------------------------------
   Modal — centered glass dialog with backdrop
--------------------------------------------------------------------------- */
export function Modal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-md rounded-xl border border-white/10 bg-[#0f0f0f] p-5 shadow-2xl">
...
/* ---------------------------------------------------------------------------
   Labeled form field + shared input class
--------------------------------------------------------------------------- */
